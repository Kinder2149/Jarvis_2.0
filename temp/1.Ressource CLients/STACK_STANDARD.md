...
**Mot de passe admin :** `admin2024` — codé en dur dans admin.js (pas de vrai backend)
...
- **Fond** : image réelle du client en `background-image`, couvrant `min-height: 90vh`
- **Overlay** : `rgba(0, 0, 0, 0.40)` minimum — jamais d'image sans overlay (lisibilité garantie)
...
- [ ] Login admin fonctionne avec le mot de passe du PROMPT_CASCADE
- [ ] Favicon présent
