...
## COMMERCE 🔒 À développer

> Placeholder — développement prévu après validation du process restauration.

Catégorie cible : boutiques, commerces de détail, artisans vendeurs.
Douleur principale : gestion des commandes/catalogue sans outil dédié.
Outils prévus : Catalogue produits, Commande en ligne, Suivi commandes.

---

## PRATICIEN LIBÉRAL 🔒 À développer

> Placeholder — développement prévu après validation du process restauration.

Catégorie cible : kinés, ostéos, naturopathes, coachs, thérapeutes.
Douleur principale : agenda géré par téléphone, pas de prise de RDV en ligne.
Outils prévus : Prise de RDV, Agenda semaine, Prestations + tarifs.

---

## ASSOCIATION 🔒 À développer

> Placeholder — développement prévu après validation du process restauration.

Catégorie cible : associations locales, clubs sportifs, structures culturelles.
Douleur principale : adhésions gérées sur papier, communication dispersée.
Outils prévus : Adhésion en ligne, Événements / agenda, Membres actifs.

---

## ARTISAN 🔒 À développer

> Placeholder — développement prévu après validation du process restauration.

Catégorie cible : menuisiers, peintres, électriciens, plombiers, maçons.
Douleur principale : demandes de devis par téléphone, pas de vitrine des réalisations.
Outils prévus : Demande de devis, Galerie réalisations, Témoignages clients.

---

*Créé le 2026-04-15 — Restauration V1 complète — 4 autres catégories en placeholder*
